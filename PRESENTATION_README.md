...
- **Tagging:** All resources tagged with `hackathon25-codetodocsai`
...
│                                                     │
│  (All tagged: project=hackathon25-codetodocsai)    │
└─────────────────────────────────────────────────────┘
```
...
gcloud run services list --filter='metadata.labels.project=hackathon25-codetodocsai'
```
